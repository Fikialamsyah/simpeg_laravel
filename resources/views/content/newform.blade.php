                ...
                <div class="form-group mt-2">
                    ...
                    <div class="row">
                        <div class="col d-flex justify-content-between">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input sr-only" type="radio" name="golongan_id" id="inlineRadio1" required value="1">
                                <label class="form-check-label" for="inlineRadio1">Golongan 1</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input sr-only" type="radio" name="golongan_id" id="inlineRadio2" required value="2">
                                <label class="form-check-label" for="inlineRadio2">Golongan 2</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input sr-only" type="radio" name="golongan_id" id="inlineRadio2" required value="3">
                                <label class="form-check-label" for="inlineRadio2">Golongan 3</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input sr-only" type="radio" name="golongan_id" id="inlineRadio2" required value="4">
